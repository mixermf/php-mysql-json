...
if ($_REQUEST['phone']) {
    ...
    if (strlen($phone) == 11) {
        ...
        $sms_template = "!\n\nБлагодарим Вас за выбор БИНБАНКа и заявку на продукт \"Накопительное страхование жизни\". В ближайшее время с Вами свяжется специалист для подробной консультации. \nВаш БИНБАНК Премиум.\n\npremium.binbank.ru\n8 800 555 5577\nПАО \"БИНБАНК\"";
